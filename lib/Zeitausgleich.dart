...
String _allbalnce = '0';
class Zeitausgleich extends StatefulWidget {
  const Zeitausgleich({super.key});
  @override
  State<Zeitausgleich> createState() => _Zeitausgleich();
}
class _Zeitausgleich extends State<Zeitausgleich> {
        ...
        child: StreamBuilder<DocumentSnapshot>(
            ...
            builder: (BuildContext context,
              ...
              if (snapshot.hasData) {
                ...
                for (int i = 1; i < 13; i++) {
                  List stamps = Calculate()
                      .getMonth(data['stamps'], i.toString(), _year.toString());
                  _balance.add(Calculate().toDoubleWithTwoDecimal(Calculate()
                              ...
                              IconButton(
                                  onPressed: () async {
                                    ...
                                    FirebaseFirestore.instance
                                        ...
                                        .doc(user!.uid)
                                        .update({
                                      'comptime': FieldValue.arrayUnion(
